...
import complaintImage from "../../assets/complaintImgs/complaintImage.jpeg";
...
const ComplaintsPage = () => {
    ...
    return (
        <div className="p-8 max-w-6xl mx-auto mt-20 grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
            <div className="">
                {successMessage && <p className="text-green-600 text-center mb-4">{successMessage}</p>}
                {errorMessage && <p className="text-red-600 text-center mb-4">{errorMessage}</p>}
                <h1 className="text-3xl font-bold mb-6 text-primary text-left">Reklamasjonsskjema</h1>
            ...
            <div className="mt-20">
                <img src={complaintImage} alt="Reklamasjon. Bilde." className="rounded-lg mb-6 shadow-lg w-full object-cover" />
                <p className="mb-6 text-gray-800 leading-relaxed text-left">
                    ...
                    Alt sendes inn via reklmamasjonsskjemaet – og du får alltid svar skriftlig fra oss.
                </p>
            </div>
        </div>
    )
